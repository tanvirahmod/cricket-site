...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return {
        title: `Browse the word by first letter | livecricket.watch`,
        description: `Browse the word by first letter`,
        alternates: {
            canonical: `https://livecricket.watch/players/by-first-letter`
        },
        openGraph: {
            title: `Browse the word by first letter | livecricket.watch`,
            description: `Browse the word by first letter`,
...
export default function ByFirstLetter() {
    ...
    return (
        ...
        <div className="w-full lg:w-2/3 mx-auto h-screen p-8 px-10 flex flex-col gap-4">
            ...
            <h2 className="text-slate-600 md:text-3xl text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-slate-800 text-center">Browse the word by first letter</h2>

            <h3 className="md:text-2xl font-semibold text-slate-800 text-center mt-9">Explore Players by First Letter.</h3>
